...
handles.productPhrase = document.getElementById('product-phrase');
...
handles.searchProducts = document.getElementById('search-products');
...
handles.searchProducts.addEventListener('click', function () { controller.searchProduct(handles.productPhrase.value); });
handles.updateProducts.addEventListener('click', function () { controller.updateProductsAsync(); });
handles.etl.addEventListener('click', function () { controller.extractData(handles.productPhrase.value, true); });
handles.extract.addEventListener('click', function () { controller.extractData(handles.productPhrase.value); });
